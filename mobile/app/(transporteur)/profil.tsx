  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <Card style={styles.menuCard} padding="none">
        ...
        <MenuItem emoji="🚚" label="Mes véhicules" onPress={() => {}} />
        <View style={styles.menuSeparator} />
        <MenuItem emoji="📄" label="Mes documents" onPress={() => {}} />
        <View style={styles.menuSeparator} />
      ...
      <Card style={styles.menuCard} padding="none">
        <MenuItem emoji="🏦" label="Compte bancaire" onPress={() => {}} />
        <View style={styles.menuSeparator} />
        <MenuItem emoji="📊" label="Historique des paiements" onPress={() => {}} />
      </Card>
      ...
      <Card style={styles.menuCard} padding="none">
        ...
        <View style={styles.menuSeparator} />
        <MenuItem emoji="📄" label="Conditions transporteur" onPress={() => {}} />
      </Card>
...
const styles = StyleSheet.create({
  ...
  roleBadge: { backgroundColor: 'rgba(34,197,94,0.12)', paddingHorizontal: 14, paddingVertical: 5, borderRadius: 999 },
  roleBadgeText: { color: Colors.SUCCESS, fontWeight: '700', fontSize: 13 },
